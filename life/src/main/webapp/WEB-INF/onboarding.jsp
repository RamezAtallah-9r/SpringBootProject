...
<div class="bg-white w-full max-w-2xl p-8 rounded-2xl shadow-xl">
    ...
    <div class="grid grid-cols-4 gap-2 mb-8 text-center text-sm">
        ...
        <div class="step-title font-bold text-slate-900">
            <span class="step-number bg-slate-900 text-white px-3 py-2 rounded-full">
                1
            </span>
        ...
        <div class="step-title text-gray-400">
            <span class="step-number bg-gray-200 px-3 py-2 rounded-full">
                2
            </span>
    ...
    <form:form
        ...
        <section class="step active">
            ...
            <p class="text-gray-500 mb-6">
                Let's start with your core biometrics.
            </p>
        ...
        <section class="step">
            ...
            <div class="flex justify-between mt-7">
                ...
                <button
                    ...
                    class="border px-7 py-3 rounded-xl">
                    Back
                </button>
        ...
        <section class="step">
            ...
            <div class="mb-5">
                ...
                <form:select
                    ...
                    <form:option value="Pregnant">
                        Pregnant
                    </form:option>

                    <form:option value="Breastfeeding">
                        Breastfeeding
                    </form:option>
...
<script>
    ...
    function showStep() {
        ...
        titles.forEach((title, index) => {
            ...
            if (index === currentStep) {
                title.classList.add("font-bold", "text-slate-900");
                title.classList.remove("text-gray-400");

                numbers[index].classList.add(
                    "bg-slate-900",
                    "text-white"
                );

                numbers[index].classList.remove("bg-gray-200");
            } else {
                title.classList.remove("font-bold", "text-slate-900");
                title.classList.add("text-gray-400");

                numbers[index].classList.remove(
                    "bg-slate-900",
                    "text-white"
                );

                numbers[index].classList.add("bg-gray-200");
            }
        });
    }
    ...
    function validateCurrentStep() {
        ...
        const fields = currentSection.querySelectorAll(".field");
